...
public class TreeTest {
    ...
    public static void main(String args[]) {
        ...
        if(args.length != 1 && args.length != 2) {
            System.err.println("Usage: TreeTest <filename> [BST|AVL]\n");
            System.exit(0);
        }

        if(args.length == 2 && !args[1].equals("BST") && !args[1].equals("AVL")) {
            System.err.println("Usage: TreeTest <filename> [BST|AVL]\n");
            System.exit(0);
        }
        ...
        BinarySearchTree<Integer,String> T;

        if(args.length == 1 || args[1].equals("BST"))  {
