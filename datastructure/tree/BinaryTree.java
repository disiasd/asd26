...
public abstract class BinaryTree<K,D> implements Tree<K,D>{
    ...
    private void getPreorderData(BTNode T, List<D> L) {
        if(T != null) {
            L.append(T.data);
            getPreorderData(T.left,L);
            getPreorderData(T.right,L);
        }
    }
    ...
    public List<D> getPreorderData() {
        ...
        getPreorderData(root,L);
        return L;
    }

    private void getPreorderKeys(BTNode T, List<K> L) {
        if(T != null) {
            L.append(T.key);
            getPreorderKeys(T.left,L);
            getPreorderKeys(T.right,L);
        }
    }
    ...
    public List<K> getPreorderKeys() {
        ...
        getPreorderKeys(root,L);
        return L;
    }


    private void getPostorderData(BTNode T, List<D> L) {
        if(T != null) {
            getPostorderData(T.left,L);
            getPostorderData(T.right,L);
            L.append(T.data);
        }
    }
    ...
    public List<D> getPostorderData() {
        List<D> L = new ArrayList<>();
        getPostorderData(root,L);
        return L;
    }

    private void getPostorderKeys(BTNode T, List<K> L) {
        if(T != null) {
            getPostorderKeys(T.left,L);
            getPostorderKeys(T.right,L);
            L.append(T.key);
        }
    }
    ...
    public List<K> getPostorderKeys() {
        List<K> L = new ArrayList<>();
        getPostorderKeys(root,L);
        return L;
    }

    private void getInorderData(BTNode T, List<D> L) {
        if(T != null) {
            getInorderData(T.left,L);
            L.append(T.data);
            getInorderData(T.right,L);
        }
    }
    ...
    public List<D> getInorderData() {
        List<D> L = new ArrayList<>();
        getInorderData(root,L);
        return L;
    }

    private void getInorderKeys(BTNode T, List<K> L) {
        if(T != null) {
            getInorderKeys(T.left,L);
            L.append(T.key);
            getInorderKeys(T.right,L);
        }
    }
    ...
    private String toString(BTNode T, String line) {
        if(T == null) {
            return "";
        } else {
            String newline;
            if(T.isLeftChild() && T.hasBrother())
                ...
                newline = line + "      ";
            return getLine(T,line) + toString(T.left,newline) + toString(T.right,newline);
        }   
    }
